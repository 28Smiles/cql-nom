...
impl<'de, E: ParseError<&'de str>> Parse<&'de str, E> for CqlUserDefinedType<&'de str, CqlIdentifier<&'de str>> {
    fn parse(input: &'de str) -> IResult<&'de str, Self, E> {
        ...
        fn parse_field<'de, E: ParseError<&'de str>>(input: &'de str) -> IResult<&'de str, (CqlIdentifier<&'de str>, CqlType<CqlIdentifier<&'de str>>), E> {
            let (input, _) = multispace0(input)?;
